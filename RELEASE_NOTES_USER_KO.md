# 업데이트 소식 - v2.4.0 (2026-04-01 09:00 UTC)

- **[FEAT] 24시간 멈추지 않는 품질 감시**: WhaTap 모니터링 시스템을 도입했습니다. 여러분이 불편함을 느끼기 전에 저희가 먼저 문제를 발견하고 해결할 수 있도록, 시스템의 건강 상태를 실시간으로 꼼꼼히 체크합니다.
- **[OPTIMIZE] 전 세계 어디서든 정확한 시간**: 더 이상 시차 때문에 머리 아파하지 마세요! 타임존 처리 방식을 완전히 개선하여, 서울에서 뉴욕까지 어느 지역에서 접속하더라도 여러분의 업무 통계를 정확하게 보여드립니다.
- **[UI] 눈이 즐거운 성취감**: 업적(Achievement) 화면과 상태 아이콘을 더 세련된 디자인으로 다듬었습니다. 차곡차곡 쌓이는 업무 성과를 확인하는 즐거움을 시각적으로도 느껴보세요.
- **[SYS] 더 가깝게 전하는 소식**: 앱 내부 시스템 최적화를 통해 지금 보고 계시는 업데이트 소식을 여러분의 언어로 더욱 빠르고 안정적으로 전달해 드릴 수 있게 되었습니다.

---

# 업데이트 소식 - v2.3.15 (2026-03-30 10:00 UTC)

- **[FIX] 끝까지 들려주는 AI 리포트**: AI가 가끔 말을 하다가 멈추던 현상을 기억하시나요? 주간 리포트 내용이 중간에 잘리지 않도록 수정하여 이제 분석 결과를 끝까지 완벽하게 확인하실 수 있습니다.
- **[FEAT] 더 쾌적해진 모바일 환경**: 모바일 화면의 여백과 간격을 미세하게 조정했습니다. 이제 밖에서도 스마트폰으로 업무를 확인하는 것이 훨씬 편안해집니다.
- **[STABILITY] 완벽한 "업무 끝!"의 즐거움**: 대시보드의 'All Clear' 상태 체크 로직을 다듬었습니다. 모든 업무를 마친 그 상쾌한 순간을 이제 더 정확하게 체감해 보세요.
