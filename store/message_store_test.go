...
func TestGetRoomDefaultActor_DominanceGating(t *testing.T) {
	...
	insertActorSample(t, ctx, email, room, "requester1", "Phathit")
	insertActorSample(t, ctx, email, room, "requester2", "Phathit")
	insertActorSample(t, ctx, email, room, "requester3", "Phathit")
	insertActorSample(t, ctx, email, room, "requester4", "Other")
	...
	insertActorSample(t, ctx, email, sparseRoom, "req", "OnlyOne")
	...
	mixed := "biz-mixed"
	insertActorSample(t, ctx, email, mixed, "r1", "A")
	insertActorSample(t, ctx, email, mixed, "r2", "A")
	insertActorSample(t, ctx, email, mixed, "r3", "B")
	insertActorSample(t, ctx, email, mixed, "r4", "B")
...
func insertActorSample(t *testing.T, ctx context.Context, email, room, requester, assignee string) {
	t.Helper()
