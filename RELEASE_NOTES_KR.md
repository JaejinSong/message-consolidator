...
## ⚡ 실시간 토큰 동기화 및 UI 가독성 개선
- **[FEAT] 실시간 토큰 사용량 자동 갱신**: 대시보드 기동 시 및 1분마다 주기적으로 토큰 사용량을 자동 업데이트하도록 설정하여, 별도의 새로고침 없이도 최신 AI 비용 현황을 확인할 수 있습니다.
- **[OPTIMIZE] 다국어 날짜 표기 최적화**: `renderer.js`의 "어제" 표기 로직을 공통 i18n 데이터 구조를 사용하도록 개선하여 언어별 일관성을 확보했습니다.
- **[UI] 토큰 상세 툴팁 고도화**: 토큰 배지 툴팁에서 오늘 사용량(Prompt/Completion 분리)과 이번 달 누적 사용량 및 예상 비용을 더욱 상세하고 명확한 형식으로 표시합니다.
