...
export const ko: I18nEntry = {
        ...
        lineMonitoring: "LINE: 모니터링 중",
        lineWebhookNotice: "LINE 봇이 활성화되었습니다. Webhook URL: /api/line/webhook",
        lineSetupNotice: "설정 → 채널에서 LINE_CHANNEL_SECRET과 LINE_CHANNEL_TOKEN을 입력하면 활성화됩니다.",
        connStatusLabel: "상태",
        connEmptyValue: "—",
