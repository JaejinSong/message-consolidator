...
export const en: I18nEntry = {
        ...
        telegramMonitoring: "Telegram: Monitoring",
        telegramStatusConnectedTitle: "Telegram: Connected",
        telegramStatusClickToConnect: "Telegram: Click to connect",
        telegramStatusConnected: "Telegram Connected",
        telegramTitle: "Telegram Integration",
        telegramDesc: "Click the Telegram icon on the dashboard to link your user account.",
        telegramConnectedDesc: "Telegram is securely connected and monitoring new messages.",
        telegramPhoneDesc: "Enter your phone number in international format (e.g. +821012345678).",
        telegramCodeDesc: "Enter the code sent to your Telegram app.",
        telegramPasswordDesc: "Two-factor authentication is enabled. Enter your cloud password.",
        telegramPhoneLabel: "Phone number",
        telegramCodeLabel: "Verification code",
        telegramPasswordLabel: "2FA password",
        telegramSendCodeBtn: "Send Code",
        telegramConfirmBtn: "Confirm",
        telegramDisconnectBtn: "Disconnect",
        telegramCredsDesc: "Paste the App ID and App Hash issued at my.telegram.org/apps.",
        telegramCredsLink: "Open my.telegram.org/apps ↗",
        telegramAppIdLabel: "App ID",
        telegramAppHashLabel: "App Hash",
        telegramSaveCredsBtn: "Save & Continue",
        telegramChangeCredsBtn: "Change App ID / Hash",
        ...
        lineWebhookNotice: "LINE bot is active. Webhook URL: /api/line/webhook",
        lineSetupNotice: "Set LINE_CHANNEL_SECRET and LINE_CHANNEL_TOKEN in Settings → Channels to activate.",
