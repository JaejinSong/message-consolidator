...
- [FEAT] Add noise filtering metrics to token usage statistics visualization
- [OPTIMIZE] Reduce processing overhead by ignoring WhatsApp profile update events
- [REFACTOR] Implement internal transactions and state synchronization for message store
- [REFACTOR] Enhance Gmail parsing accuracy via external library integration
- [OPTIMIZE] Improve Gmail CC restoration performance using pagination and batching
...
- [FEAT] Automate VPS deployment and build optimization using Docker Compose and Caddy
- [OPTIMIZE] Improve Alias Store cache performance by metadata caching before lock release
- [REFACTOR] Standardize Context propagation across store and database layers for lifecycle management
- [REFACTOR] Modularize WhatsApp message handling and enhance system message filtering
- [REFACTOR] Modernize codebase by migrating ioutil to os package and cleaning unused services
...
- [FEAT] Implement idempotency layer to ensure reliable message processing
- [FEAT] Introduce automation for release note generation workflow
- [FIX] Resolve version hijacking vulnerabilities within the deployment pipeline
