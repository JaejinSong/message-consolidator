...
func (a *API) RegisterRoutes(r *mux.Router) {
	...
	r.Handle("/api/telegram/status", auth.AuthMiddleware(http.HandlerFunc(a.HandleTelegramStatus))).Methods("GET")
	r.Handle("/api/telegram/auth/start", auth.AuthMiddleware(http.HandlerFunc(a.HandleTelegramAuthStart))).Methods("POST")
